Projeto realizado para automação web em conjunto com Selenium, para que seja possível a automatização de sites que requerem resolução de captcha de letras e numeros em imagens embaralhadas no padrão  :
